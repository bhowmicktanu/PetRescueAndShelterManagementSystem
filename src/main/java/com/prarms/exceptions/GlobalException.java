...
public class GlobalException {
	...
	public ResponseEntity<?>UniqueConstraintHandling(DataIntegrityViolationException ex,WebRequest request){
	...
	public ResponseEntity<?>DatNotFoundHandling(DataNotFoundException ex,WebRequest request){
		ErrorDetails errors=new ErrorDetails(new Date(),ex.getMessage(),request.getDescription(false));
